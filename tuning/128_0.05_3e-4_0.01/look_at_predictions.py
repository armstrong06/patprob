...
import os
figdir="/home/armstrong/Research/git_repos/patprob/tuning/128_0.05_3e-4_0.01/figures"
...
density_scatter(meta_df[meta_df["pick_quality"] == 1]["pick_quality"].values, pred_std[one_inds], ax=ax)
